...
2. Navigate (`cd`) to the example directory on your system
   ...
   ```
   cd extension-examples/react/javascript/demo-extension-sdk
   ```
...
6. Create a `model` LookML file in your project. The name doesn't matter but the convention is to name it the same as the project— in this case, demo-extension-sdk.
